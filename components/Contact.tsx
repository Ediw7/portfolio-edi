...
import Lanyard from "./lanyard/Lanyard"; // Pastikan path import sesuai lokasi file Lanyard.tsx kamu
  ...
  return (
    <footer id="contact" className="relative w-full bg-black text-white px-6 md:px-12 py-20 md:py-32 border-t border-white/5 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute -bottom-20 -left-20 md:-bottom-[10%] md:-left-[10%] w-80 h-80 md:w-[1000px] md:h-[1000px] bg-red-900/50 md:bg-red-900/20 rounded-full blur-3xl md:blur-[180px] mix-blend-screen" />
        <div className="absolute -top-20 -right-20 md:-top-[10%] md:-right-[10%] w-64 h-64 md:w-[800px] md:h-[800px] bg-indigo-900/50 md:bg-indigo-900/15 rounded-full blur-3xl md:blur-[180px] mix-blend-screen" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-40 h-40 md:w-[600px] md:h-[600px] bg-white/5 rounded-full blur-2xl md:blur-[200px] opacity-20" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-stretch lg:items-center mb-24 gap-12 border-b border-white/5 pb-24">
          ...
          <div className="flex-1 max-w-4xl">
            ...
            <p className="text-neutral-400 text-lg md:text-xl max-w-lg leading-relaxed font-light mb-10">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-8">
                ...
                className="group relative flex items-center justify-between gap-4 bg-white text-black px-8 py-5 md:px-10 rounded-full font-bold text-xs tracking-[0.2em] uppercase transition-all hover:bg-neutral-200 shadow-[0_0_40px_rgba(255,255,255,0.1)]"
                >
