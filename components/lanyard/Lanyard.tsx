  ...
  return (
    <div className="relative z-0 w-full h-screen flex justify-center items-center">
      ...
      >
        ...
        <Physics gravity={gravity} interpolate timeStep={isMobile ? 1 / 30 : 1 / 60}>
  ...
  return (
    <>
      <group position={[0, 4, 0]}>
        ...
        <RigidBody position={[0.5, 0, 0]} ref={j1} type="dynamic" linearDamping={4} angularDamping={4}>
          <BallCollider args={[0.1]} />
        </RigidBody>
        <RigidBody position={[1, 0, 0]} ref={j2} type="dynamic" linearDamping={4} angularDamping={4}>
          <BallCollider args={[0.1]} />
        </RigidBody>
        <RigidBody position={[1.5, 0, 0]} ref={j3} type="dynamic" linearDamping={4} angularDamping={4}>
          <BallCollider args={[0.1]} />
        </RigidBody>
